...
SETTINGS_REGISTRY: Dict[str, SettingMeta] = {
    ...
    "ML_JOB_POLL_SECONDS": SettingMeta("float", "sec", 0.2, 60, None, "worker_restart"),
    "ML_JOB_LEASE_SECONDS": SettingMeta("integer", "sec", 20, 3600, None, "worker_restart"),
    "ML_JOB_HEARTBEAT_SECONDS": SettingMeta("float", "sec", 1, 300, None, "worker_restart"),
    "ML_JOB_TERMINATE_GRACE_SECONDS": SettingMeta("float", "sec", 1, 300, None, "worker_restart"),
    ...
    "SQL_AGENT_MAX_MODEL_CALLS": SettingMeta("integer", "count", 1, 100, None, "api_restart"),
    "SQL_AGENT_MAX_TOOL_CALLS": SettingMeta("integer", "count", 1, 50, None, "api_restart"),
    "SQL_AGENT_MAX_RUN_TOKENS": SettingMeta("integer", "tokens", 1024, 1000000, None, "api_restart"),
    "SQL_AGENT_MEMORY_RETENTION_DAYS": SettingMeta("integer", "days", 1, 365, None, "api_restart"),
