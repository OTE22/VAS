...
async def sync_settings_from_config(db: AsyncSession):
    ...
    categories = {
        ...
        "sql_agent": ["CHROMADB_PATH", "CHROMA_COLLECTION_NAME", "RAG_TOP_K", "RAG_SIMILARITY_THRESHOLD",
                     ...
                     "SQL_AGENT_USE_KNOWLEDGE_BASE", "SQL_AGENT_MAX_QUERY_CHARS",
        ...
        for key in keys:
            if hasattr(config_settings, key):
                ...
                custom_descriptions = {
                    ...
                    "SQL_AGENT_USE_KNOWLEDGE_BASE": "Put the verified examples in front of SQL generation. Turn it off only to measure what the knowledge base contributes; the seeds are what make a hard query correct.",
