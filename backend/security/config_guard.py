...
SECURITY_CRITICAL_KEYS = frozenset({
    ...
    # LAF-AI SSO hand-off: a writable chatbot URL would let an admin token
    # redirect every TRACKING ticket to a host of its choosing (2026-09-12).
    "LAF_AI_SSO_ENABLED", "LAF_AI_CHATBOT_URL", "LAF_AI_GATE_URL",
    "LAF_AI_SSO_TICKET_TTL_SECONDS", "LAF_AI_SSO_SECRET", "LAF_AI_SSO_SECRET_FILE",
