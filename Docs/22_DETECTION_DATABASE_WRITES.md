...
Failure classes (see Docs/04): **A** core failure = nothing committed;
...
- `31_UNKNOWN_FACES_ARCHITECTURE.md` - How unknown faces are handled
- `23_VECTOR_INDEX_CONTRACT.md` - pgvector vs FAISS
- `34_PROMOTION_FLOW.md` - How to promote unknown to known
