...
| Head | `fdd4e5f6a7b8`, following `fcc3d4e5f6a7`: exact appearance/detection provenance. See [September deployment](59_SEPTEMBER_DEPLOYMENT_UPDATE.md) for backfill and rollback semantics. |
