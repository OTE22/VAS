...
- [ML Operations](#ml-operations) — 50 operations
- [SQL Agent](#sql-agent) — 22 operations
...
| Method | Path | Summary | Path params | Query | Body | Returns |
|---|---|---|---|---|---|---|
| `GET` | `/api/health/offline-policy` | Offline Policy Report | — | — | — | 200 |
| `GET` | `/health` | Health Check | — | — | — | 200 |
| `GET` | `/health/detailed` | Detailed Health Check | — | — | — | 200 |
| `GET` | `/health/live` | Liveness Check | — | — | — | 200 |
| `GET` | `/health/offline-policy` | Offline Policy Report | — | — | — | 200 |
...
| `GET` | `/api/ml/capabilities` | Platform Capabilities | — | — | — | 200 |
| `GET` | `/api/ml/comparisons` | Compare Experiments | — | `model_ids` | — | 200, 422 |
| `PUT` | `/api/ml/config/mode` | Change Decision Mode | — | — | yes | 200, 422 |
| `GET` | `/api/ml/datasets` | List Datasets | — | `page`, `page_size` | — | 200, 422 |
| `POST` | `/api/ml/datasets` | Build Dataset | — | — | yes | 202, 422 |
| `POST` | `/api/ml/datasets/backfill-hashes` | Verify legacy datasets and record their file hashes | — | — | — | 202 |
...
| `GET` | `/api/ml/datasets/{dataset_id}/explorer` | Dataset Explorer | `dataset_id` | `page`, `page_size`, `split`, `label`, `q` | — | 200, 422 |
| `GET` | `/api/ml/datasets/{dataset_id}/validation-report` | Dataset Explorer | `dataset_id` | `page`, `page_size`, `split`, `label`, `q` | — | 200, 422 |
| `GET` | `/api/ml/drift/reports` | Drift Reports | — | `page`, `page_size`, `model_id` | — | 200, 422 |
| `POST` | `/api/ml/drift/run` | Run Drift Check Now | — | — | — | 202 |
| `GET` | `/api/ml/experiments` | List Experiments | — | — | — | 200 |
| `POST` | `/api/ml/experiments/{job_id}/retry` | Retry Tracking | `job_id` | — | yes | 202, 422 |
...
| `GET` | `/api/ml/jobs` | List ML Jobs | — | `status`, `limit` | — | 200, 422 |
| `GET` | `/api/ml/jobs/{job_id}` | ML Job Status | `job_id` | — | — | 200, 422 |
| `POST` | `/api/ml/jobs/{job_id}/cancel` | Cancel ML Job | `job_id` | — | — | 200, 422 |
...
| `GET` | `/api/ml/models/{model_id}/explanations` | Model Explanations | `model_id` | `sample` | — | 200, 422 |
| `GET` | `/api/ml/models/{model_id}/explanations/download/{filename}` | Download Explanation | `model_id`, `filename` | — | — | 200, 422 |
| `POST` | `/api/ml/models/{model_id}/promote` | Promote Offline Model | `model_id` | — | yes | 200, 422 |
...
| `GET` | `/api/ml/pipelines` | List Pipeline Versions | — | — | — | 200 |
| `POST` | `/api/ml/pipelines` | Create Pipeline Version | — | — | yes | 201, 422 |
| `GET` | `/api/ml/predictions` | List Predictions | — | `subject_id`, `fallback_only`, `page`, `page_size` | — | 200, 422 |
| `POST` | `/api/ml/rank/threat-review` | Rank identities for analyst review | — | — | yes | 200, 422 |
...
| `POST` | `/api/ml/score/relational` | Run an observational relational shadow score | — | — | yes | 200, 422 |
...
| `GET` | `/api/sql-agent/requests/{request_id}/trace` | Get Sql Agent Trace | `request_id` | — | — | 200, 422 |
...
| `POST` | `/api/upload-person` | Create a person from a photo (the Add Person modal) | — | — | yes | 200, 422 |
...
| `POST` | `/api/audit/chatbot` | Record Chatbot Question | — | — | yes | 201, 422 |
...
| `POST` | `/api/clustering/run` | Clustering Run Now | — | — | — | 202 |
...
| `POST` | `/api/identity-retention/run` | Identity Retention Run Now | — | — | — | 202 |
...
| Method | Path | Summary | Path params | Query | Body | Returns |
|---|---|---|---|---|---|---|
| `POST` | `/api/sso/laf-ai/consume` | Consume | — | — | yes | 200, 422 |
| `GET` | `/api/sso/laf-ai/launch` | Launch | — | — | — | 200 |
| `POST` | `/api/sso/laf-ai/ticket` | Create Ticket | — | — | — | 200 |
...
Troubleshooting each of these: [`13_TROUBLESHOOTING.md`](13_TROUBLESHOOTING.md).
