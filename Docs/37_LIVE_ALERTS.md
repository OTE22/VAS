...
> socket, is authoritative (`Docs/04` § 11.1).
...
- **Advanced Search Guide**: `36_ADVANCED_SEARCH.md` - Search features
- **Configuration Guide**: `06_CONFIGURATION_GUIDE.md` - System settings
- **API Authentication**: `45_API_AUTHENTICATION.md` - API usage
