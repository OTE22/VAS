...
Related: [58_SQL_AGENT_QUERY_HISTORY.md](58_SQL_AGENT_QUERY_HISTORY.md) for
history and sessions, [10_SECURITY_CHECKLIST.md](10_SECURITY_CHECKLIST.md)
for the production checklist, [29_DATABASE_RELATIONSHIPS.md](29_DATABASE_RELATIONSHIPS.md)
for the schema.
