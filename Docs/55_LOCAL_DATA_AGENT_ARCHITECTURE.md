...
Companion documents: `56_DATA_AGENT_CONFIGURATION.md` (setting-by-setting
configuration for both modes), `57_AGENT_ARCHITECTURE.md` (the reasoning loop in
detail), `01_SYSTEM_OVERVIEW.md`, `57_AGENT_ARCHITECTURE.md`,
`10_SECURITY_CHECKLIST.md`, `11_BACKUP_AND_RESTORE.md`.
...
Unchanged: `11_BACKUP_AND_RESTORE.md` covers PostgreSQL and storage. New
...
`57_AGENT_ARCHITECTURE.md` on the production stack, and a run with
