...
[08_SETTINGS_RUNTIME_MATRIX.md](08_SETTINGS_RUNTIME_MATRIX.md).
...
at `/change-password`. See [`04_DEPLOYMENT_RUNBOOK.md`](04_DEPLOYMENT_RUNBOOK.md) §7.
...
**See:** `23_VECTOR_INDEX_CONTRACT.md` for the authoritative contract
...
**See Also:**
- **Live Alerts Guide**: `37_LIVE_ALERTS.md` - Complete guide to creating and managing live alerts
...
**See Also:**
- **Advanced Search Intelligence Guide**: `36_ADVANCED_SEARCH.md` - Complete guide to all advanced search features
- **Search by Image Guide**: `35_SEARCH_BY_IMAGE.md` - Quick search functionality
...
- **Settings Management Guide**: `07_SETTINGS_MANAGEMENT.md`
- **FAISS Production Scaling**: `23_VECTOR_INDEX_CONTRACT.md`
- **50 Cameras Scalability**: `17_SCALABILITY.md`
- **FAISS Repair Guide**: `23_VECTOR_INDEX_CONTRACT.md`
- **Multi-Identity Merge Guide**: `33_MULTI_IDENTITY_MERGE.md`
- **Advanced Merge Flow Guide**: `33_MULTI_IDENTITY_MERGE.md`
- **Search by Image Guide**: `35_SEARCH_BY_IMAGE.md` - Quick search functionality
- **Advanced Search Intelligence Guide**: `36_ADVANCED_SEARCH.md` - Production-grade advanced search with watchlists, alerts, and intelligence
- **Live Alerts Guide**: `37_LIVE_ALERTS.md` - Complete guide to live search alerts with backend-driven defaults
- **Pipeline-Aware ML Clustering Guide**: `32_MERGE_SUGGESTIONS.md` - Pipeline-aware merge suggestions with ML-based similarity
- **ML Similarity Model Guide**: `50_ML_SIMILARITY_MODEL.md` - Trainable neural network for improving merge suggestion accuracy
