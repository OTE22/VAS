        ...
        "tables": {
            ...
            "pipelines": {
                ...
                "columns": [
                    ...
                    {"column_name": "is_active", "data_type": "integer", "is_nullable": "NO", "description": "1 = active, 0 = inactive. An INTEGER column, not a boolean: compare with = 1 or = 0, never with TRUE/FALSE (that raises 'operator does not exist: integer = boolean')"},
